                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $train_ef_arr = array_column($res,'second_class_capacity','id');
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-0">
                                        ...
                                        <div class="px-1"><span class="text-muted">Second Class:</span> <span class="text-muted fa fa-user"></span> <b><?= $row['type'] == 1 ? "<i class='fa fa-question' title='Slot depends to the date you desire.'></i>" : number_format($e_slot) ?></b> <span class="text-muted ml-2 fa fa-tag"></span> <b><?= rtrim(number_format($row['second_class_fare'],2),'.') ?></b></div>
                                    </td>
