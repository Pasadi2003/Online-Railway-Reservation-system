...
CREATE TABLE `reservation_list` (
  ...
  `seat_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1=First Class, 2 = Second Class',
...
CREATE TABLE `schedule_list` (
  ...
  `second_class_fare` float NOT NULL DEFAULT 0,
...
INSERT INTO `schedule_list` (`id`, `code`, `train_id`, `route_from`, `route_to`, `type`, `date_schedule`, `time_schedule`, `first_class_fare`, `second_class_fare`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
CREATE TABLE `train_list` (
  ...
  `second_class_capacity` float NOT NULL DEFAULT 0,
  `delete_flag` tinyint(1) NOT NULL DEFAULT 0,
  `date_created` datetime NOT NULL DEFAULT current_timestamp(),
  `date_updated` datetime DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `train_list` (`id`, `code`, `name`, `first_class_capacity`, `second_class_capacity`, `delete_flag`, `date_created`, `date_updated`) VALUES
