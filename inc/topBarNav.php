      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php endif; ?>
            <?php else: ?>
              <a href="./admin" class="mx-2 text-light">Admin </a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=schedules" class="nav-link <?= isset($page) && $page =='schedules' ? "active" : "" ?>">Appointment</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="userlogin.php" class="nav-link <?= isset($page) && $page =='profile' ? "active" : "" ?>">User Profile</a>
              </li>
              <li class="nav-item">
                <a href="tracking.php" class="nav-link <?= isset($page) && $page =='tracking' ? "active" : "" ?>">Location</a>
              </li>
