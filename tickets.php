...
$train_group = ['','First Class','Second Class'];
?>
    ...
    <div class="card rounded-0 card-outline card-primary shadow">
        <div class="card-header rounded-0">
            ...
            <div class="card-tools">
                ...
                <a href="payments.php">
                <button  class="btn btn-sm btn-flat btn-success"  id="print"><i class="fa fa-credit-card"></i> Payment</button></a>
                <a href="#">
        ...
        <div class="card-body rounded-0">
            <div id="outprint" class="list-group">
                ...
                <div class="row">
                        <div class="col-auto pr-2"><b>Payment Status: UNPAID</b></div>
