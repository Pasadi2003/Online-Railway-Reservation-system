...
<div class="container-fluid">
    <form action="" id="train-form">
        ...
        <div class="form-group">
            <label for="second_class_capacity" class="control-label">Second Class Seat Capacity</label>
            <input type="number" name="second_class_capacity" id="second_class_capacity" class="form-control form-control-border text-right" value ="<?php echo isset($second_class_capacity) ? $second_class_capacity : 0 ?>" required>
        </div>
    </form>
</div>
<script>
