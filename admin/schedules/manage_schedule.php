    ...
    <form action="" id="schedule-form">
        ...
        <fielset>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label for="second_class_fare" class="control-label">Second Class</label>
                    <input type="number" name="second_class_fare" id="second_class_fare" class="form-control form-control-sm form-control-border text-right" required value="<?= isset($second_class_fare) ? $second_class_fare : "" ?>"/>
                </div>
            </div>
        </fielset>
    </form>
