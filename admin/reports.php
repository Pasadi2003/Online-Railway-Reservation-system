...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="navbar-header">
		...
		<h4 style="padding-left: 100px;padding-top: 20px;">REPORT</h4>
	</div>
...
<div class="container-fluid">
  ...
  <div class="col-sm-8">
    <div class="row">
      <div class="col-xs-12">
        <h3 style="padding-left: 100px;">Pupz Vet Clinic Reports </h3>
		<hr >
...
$ret=mysqli_query($con,"select month(OrderDate) as lmonth,year(OrderDate) as lyear,
    tblproduct.SellingPrice,tblorder.Quantity from tblorder 
    join tblproduct on tblproduct.ID=tblorder.ProductID 
    where date(tblorder.OrderDate) between '$stands'
    group by lyear ");
$num=mysqli_num_rows($ret);
if($num>0){
$cnt=1;
