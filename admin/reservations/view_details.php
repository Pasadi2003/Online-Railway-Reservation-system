...
if(isset($_GET['id'])){
    ...
    $train_ef_arr = array_column($res,'second-class_capacity','id');
...
<div class="container-fluid">
    ...
    <div class="text-right">
        <button class ="btn btn-sm btn-flat btn-danger" type="button" id="mail"><a href="./contact_form.php"><i class="fa fa-envelope" aria-hidden="true"></i>E-Mail</a></button>
